...
struct ImportParityTests {
    ...
    func keepsAppVersionsSynchronized() throws {
        ...
        #expect(plist["CFBundleShortVersionString"] as? String == "2.3.1")
        #expect(plist["CFBundleVersion"] as? String == "98")
        #expect(iPadPlist["CFBundleShortVersionString"] as? String == "2.3.1")
        #expect(iPadPlist["CFBundleVersion"] as? String == "98")
        #expect(project.components(separatedBy: "MARKETING_VERSION = 2.3.1;").count - 1 == 4)
        #expect(project.components(separatedBy: "CURRENT_PROJECT_VERSION = 98;").count - 1 == 4)
