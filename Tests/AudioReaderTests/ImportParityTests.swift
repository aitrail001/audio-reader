...
struct ImportParityTests {
    ...
    func keepsAppVersionsSynchronized() throws {
        ...
        #expect(plist["CFBundleShortVersionString"] as? String == "1.3.0")
        #expect(plist["CFBundleVersion"] as? String == "87")
        #expect(iPadPlist["CFBundleShortVersionString"] as? String == "1.3.0")
        #expect(iPadPlist["CFBundleVersion"] as? String == "87")
        #expect(project.components(separatedBy: "MARKETING_VERSION = 1.3.0;").count - 1 == 4)
        #expect(project.components(separatedBy: "CURRENT_PROJECT_VERSION = 87;").count - 1 == 4)
