...
struct ImportParityTests {
    ...
    func keepsAppVersionsSynchronized() throws {
        ...
        #expect(plist["CFBundleShortVersionString"] as? String == "2.4.0")
        #expect(plist["CFBundleVersion"] as? String == "101")
        #expect(iPadPlist["CFBundleShortVersionString"] as? String == "2.4.0")
        #expect(iPadPlist["CFBundleVersion"] as? String == "101")
        #expect(project.components(separatedBy: "MARKETING_VERSION = 2.4.0;").count - 1 == 4)
        #expect(project.components(separatedBy: "CURRENT_PROJECT_VERSION = 101;").count - 1 == 4)
