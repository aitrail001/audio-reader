...
struct PlatformParityContractTests {
    ...
    func sharesEbookOnlyImportAndAddAudio() throws {
        ...
        #expect(appleBooks.contains("AppleBooksEbookCatalog.records(fromPlist:"))
        #expect(appleBooks.contains("EPUBParser.isPackage(at:"))
        ...
        #expect(appleBooks.contains("structure?.cover?.data"))
